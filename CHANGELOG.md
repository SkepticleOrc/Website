...
- **Roadmap Initialization**: Created and deployed the public `Roadmap.md` file to transparently track active, planned, and long-term portfolio goals for potential employers.
- **Academic Disclaimer Added**: Documented university coursework boundaries regarding future code availability to strictly protect against plagiarism risks and intellectual property theft.

### HTML & Content Architecture
- **Semantic About Me Refactor**: Completely updated the primary biography section, wrapping text into semantic blocks.
- **Copy Polish**: Upgraded biography paragraphs to industry-ready language, correcting past typos and refining the overall professional narrative.

### Projects & Labs
- **Anniversary Project Case Study**: Completed a custom, vanilla HTML5/CSS3/JS anniversary webpage layout featuring custom structural micro-interactions and smooth asset optimization.
